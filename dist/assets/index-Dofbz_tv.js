 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var km;function ex(){if(km)return Ss;km=1;var r=rl(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),s=Object.prototype.hasOwnProperty,o=r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function u(h,p,m){var v,y={},w=null,I=null;m!==void 0&&(w=""+m),p.key!==void 0&&(w=""+p.key),p.ref!==void 0&&(I=p.ref);for(v in p)s.call(p,v)&&!l.hasOwnProperty(v)&&(y[v]=p[v]);if(h&&h.defaultProps)for(v in p=h.defaultProps,p)y[v]===void 0&&(y[v]=p[v]);return{$$typeof:e,type:h,key:w,ref:I,props:y,_owner:o.current}}return Ss.Fragment=t,Ss.jsx=u,Ss.jsxs=u,Ss}var Im;function tx(){return Im||(Im=1,_u.exports=ex()),_u.exports}var _=tx(),wa={},wu={exports:{}},xt={},xu={exports:{}},Su={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Tm;function nx(){return Tm||(Tm=1,(function(r){function e(j,H){var z=j.length;j.push(H);e:for(;0<z;){var C=z-1>>>1,P=j[C];if(0<o(P,H))j[C]=H,j[z]=P,z=C;else break e}}function t(j){return j.length===0?null:j[0]}function s(j){if(j.length===0)return null;var H=j[0],z=j.pop();if(z!==H){j[0]=z;e:for(var C=0,P=j.length,Z=P>>>1;C<Z;){var re=2*(C+1)-1,de=j[re],ge=re+1,Ne=j[ge];if(0>o(de,z))ge<P&&0>o(Ne,de)?(j[C]=Ne,j[ge]=z,C=ge):(j[C]=de,j[re]=z,C=re);else if(ge<P&&0>o(Ne,z))j[C]=Ne,j[ge]=z,C=ge;else break e}}return H}function o(j,H){var z=j.sortIndex-H.sortIndex;return z!==0?z:j.id-H.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;r.unstable_now=function(){return l.now()}}else{var u=Date,h=u.now();r.unstable_now=function(){return u.now()-h}}var p=[],m=[],v=1,y=null,w=3,I=!1,N=!1,b=!1,F=typeof setTimeout=="function"?setTimeout:null,he=typeof clearTimeout=="function"?clearTimeout:null,fe=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function me(j){for(var H=t(m);H!==null;){if(H.callback===null)s(m);else if(H.startTime<=j)s(m),H.sortIndex=H.expirationTime,e(p,H);else break;H=t(m)}}function ne(j){if(b=!1,me(j),!N)if(t(p)!==null)N=!0,ue(Ie);else{var H=t(m);H!==null&&se(ne,H.startTime-j)}}function Ie(j,H){N=!1,b&&(b=!1,he(He),He=-1),I=!0;var z=w;try{for(me(H),y=t(p);y!==null&&(!(y.expirationTime>H)||j&&!bt());){var C=y.callback;if(typeof C=="function"){y.callback=null,w=y.priorityLevel;var P=C(y.expirationTime<=H);H=r.unstable_now(),typeof P=="function"?y.callback=P:y===t(p)&&s(p),me(H)}else s(p);y=t(p)}if(y!==null)var Z=!0;else{var re=t(m);re!==null&&se(ne,re.startTime-H),Z=!1}return Z}finally{y=null,w=z,I=!1}}var De=!1,Te=null,He=-1,Ae=5,ve=-1;function bt(){return!(r.unstable_now()-ve<Ae)}function ie(){if(Te!==null){var j=r.unstable_now();ve=j;var H=!0;try{H=Te(!0,j)}finally{H?q():(De=!1,Te=null)}}else De=!1}var q;if(typeof fe=="function")q=function(){fe(ie)};else if(typeof MessageChannel<"u"){var ee=new MessageChannel,we=ee.port2;ee.port1.onmessage=ie,q=function(){we.postMessage(null)}}else q=function(){F(ie,0)};function ue(j){Te=j,De||(De=!0,q())}function se(j,H){He=F(function(){j(r.unstable_now())},H)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(j){j.callback=null},r.unstable_continueExecution=function(){N||I||(N=!0,ue(Ie))},r.unstable_forceFrameRate=function(j){0>j||125<j?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Ae=0<j?Math.floor(1e3/j):5},r.unstable_getCurrentPriorityLevel=function(){return w},r.unstable_getFirstCallbackNode=function(){return t(p)},r.unstable_next=function(j){switch(w){case 1:case 2:case 3:var H=3;break;default:H=w}var z=w;w=H;try{return j()}finally{w=z}},r.unstable_pauseExecution=function(){},r.unstable_requestPaint=function(){},r.unstable_runWithPriority=function(j,H){switch(j){case 1:case 2:case 3:case 4:case 5:break;default:j=3}var z=w;w=j;try{return H()}finally{w=z}},r.unstable_scheduleCallback=function(j,H,z){var C=r.unstable_now();switch(typeof z=="object"&&z!==null?(z=z.delay,z=typeof z=="number"&&0<z?C+z:C):z=C,j){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=z+P,j={id:v++,callback:H,priorityLevel:j,startTime:z,expirationTime:P,sortIndex:-1},z>C?(j.sortIndex=z,e(m,j),t(p)===null&&j===t(m)&&(b?(he(He),He=-1):b=!0,se(ne,z-C))):(j.sortIndex=P,e(p,j),N||I||(N=!0,ue(Ie))),j},r.unstable_shouldYield=bt,r.unstable_wrapCallback=function(j){var H=w;return function(){var z=w;w=H;try{return j.apply(this,arguments)}finally{w=z}}}})(Su)),Su}var Nm;function rx(){return Nm||(Nm=1,xu.exports=nx()),xu.exports}/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ua(r){var y;const e=r.auth,t=await r.getIdToken(),s=await Ws(r,Fa(e,{idToken:t}));Y(s==null?void 0:s.users.length,e,"internal-error");const o=s.users[0];r._notifyReloadListener(o);const l=(y=o.providerUserInfo)!=null&&y.length?Zy(o.providerUserInfo):[],u=qE(r.providerData,l),h=r.isAnonymous,p=!(r.email&&o.passwordHash)&&!(u!=null&&u.length),m=h?p:!1,v={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:u,metadata:new ad(o.createdAt,o.lastLoginAt),isAnonymous:m};Object.assign(r,v)}async function GE(r){const e=ot(r);await Ua(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function qE(r,e){return[...r.filter(s=>!e.some(o=>o.providerId===s.providerId)),...e]}function Zy(r){return r.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ta(r,e,t){return`firebase:${r}:${e}:${t}`}class _i{constructor(e,t,s){this.persistence=e,this.auth=t,this.userKey=s;const{config:o,name:l}=this.auth;this.fullUserKey=Ta(this.userKey,o.apiKey,l),this.fullPersistenceKey=Ta("persistence",o.apiKey,l),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const t=await Fa(this.auth,{idToken:e}).catch(()=>{});return t?Yt._fromGetAccountInfoResponse(this.auth,t,e):null}return Yt._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,s="authUser"){if(!t.length)return new _i(En(ug),e,s);const o=(await Promise.all(t.map(async m=>{if(await m._isAvailable())return m}))).filter(m=>m);let l=o[0]||En(ug);const u=Ta(s,e.config.apiKey,e.name);let h=null;for(const m of t)try{const v=await m._get(u);if(v){let y;if(typeof v=="string"){const w=await Fa(e,{idToken:v}).catch(()=>{});if(!w)break;y=await Yt._fromGetAccountInfoResponse(e,w,v)}else y=Yt._fromJSON(e,v);m!==l&&(h=y),l=m;break}}catch{}const p=o.filter(m=>m._shouldAllowMigration);return!l._shouldAllowMigration||!p.length?new _i(l,e,s):(l=p[0],h&&await l._set(u,h.toJSON()),await Promise.all(t.map(async m=>{if(m!==l)try{await m._remove(u)}catch{}})),new _i(l,e,s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gN=Math.log(2);class yN{constructor(e){const t=l=>parseInt(Math.log(l)/gN,10),s=l=>parseInt(Array(l+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const o=s(this.count);this.bits_=e+1&o}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Ga=function(r,e,t,s){r.sort(e);const o=function(p,m){const v=m-p;let y,w;if(v===0)return null;if(v===1)return y=r[p],w=t?t(y):y,new Ze(w,y.node,Ze.BLACK,null,null);{const I=parseInt(v/2,10)+p,N=o(p,I),b=o(I+1,m);return y=r[I],w=t?t(y):y,new Ze(w,y.node,Ze.BLACK,N,b)}},l=function(p){let m=null,v=null,y=r.length;const w=function(N,b){const F=y-N,he=y;y-=N;const fe=o(F+1,he),me=r[F],ne=t?t(me):me;I(new Ze(ne,me.node,b,null,fe))},I=function(N){m?(m.left=N,m=N):(v=N,m=N)};for(let N=0;N<p.count;++N){const b=p.nextBitIsOne(),F=Math.pow(2,p.count-(N+1));b?w(F,Ze.BLACK):(w(F,Ze.BLACK),w(F,Ze.RED))}return v},u=new yN(r.length),h=l(u);return new Et(s||e,h)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class TP{constructor(e,t){this.committed=e,this.snapshot=t}toJSON(){return{committed:this.committed,snapshot:this.snapshot.toJSON()}}}function NP(r,e,t){if(r=ot(r),WR("Reference.transaction",r._path),r.key===".length"||r.key===".keys")throw"Reference.transaction failed: "+r.key+" is a read-only object.";const s=!0,o=new eo,l=(h,p,m)=>{let v=null;h?o.reject(h):(v=new Zs(m,new Rn(r._repo,r._path),ze),o.resolve(new TP(p,v)))},u=n0(r,()=>{});return iP(r._repo,r._path,e,l,u,s),o.promise}kn.prototype.simpleListen=function(r,e){this.sendRequest("q",{p:r},e)};kn.prototype.echo=function(r,e){this.sendRequest("echo",{d:r},e)};CP();const RP={apiKey:"AIzaSyBjGqNtm17fdNUfU5twhJt8Wc20OEB0B28",authDomain:"uncleaunty-app.firebaseapp.com",databaseURL:"https://uncleaunty-app-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"uncleaunty-app",storageBucket:"uncleaunty-app.firebasestorage.app",messagingSenderId:"285281834576",appId:"1:285281834576:web:b02bf5636bead00effa355",measurementId:"G-Y9JX43E2RN"},Th=Wy(RP);lT(Th);const Dr=Vk(Th),kd=SP(Th);function PP({onGetStarted:r,onCaregiverLogin:e}){const{t}=Ri(),[s,o]=te.useState(""),[l,u]=te.useState(""),[h,p]=te.useState(!1),[m,v]=te.useState(""),[y,w]=te.useState(!1),I=async N=>{N.preventDefault(),v(""),w(!0);try{await NC(Dr,s.trim(),l),r()}catch(b){console.error("Login failed:",b),v("Email or password is incorrect.")}finally{w(!1)}};return _.jsx("div",{className:"h-full overflow-y-auto bg-gray-50",children:_.jsx("div",{className:"flex min-h-full items-center justify-center px-5 py-6 min-[390px]:px-8 min-[390px]:py-8",children:_.jsxs("div",{className:"w-full rounded-3xl bg-white p-5 shadow-lg min-[390px]:p-8",children:[_.jsxs("div",{className:"mb-5 flex items-center gap-3 min-[390px]:mb-8",children:[_.jsx("div",{className:"flex h-12 w-12 items-center justify-center rounded-2xl border-2 border-gray-800 min-[390px]:h-14 min-[390px]:w-14",children:_.jsx(Fx,{className:"h-6 w-6 text-gray-800 min-[390px]:h-7 min-[390px]:w-7"})}),_.jsxs("div",{children:[_.jsx("h2",{className:"text-xl font-bold min-[390px]:text-2xl",children:t("careConnect")}),_.jsx("p",{className:"text-sm text-gray-600",children:t("mobile")})]})]}),_.jsx("h1",{className:"mb-5 text-center text-4xl font-bold leading-tight min-[390px]:mb-8 min-[390px]:text-5xl",children:t("welcomeBack")}),_.jsxs("form",{onSubmit:I,className:"space-y-4 min-[390px]:space-y-6",children:[_.jsxs("div",{children:[_.jsx("label",{className:"mb-2 block text-lg font-bold text-gray-900 min-[390px]:mb-3 min-[390px]:text-xl",children:t("email")}),_.jsxs("div",{className:"relative",children:[_.jsx(Hx,{className:"absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-gray-400 min-[390px]:h-6 min-[390px]:w-6"}),_.jsx("input",{type:"email",value:s,onChange:N=>o(N.target.value),placeholder:t("enterEmail"),required:!0,className:"w-full rounded-2xl border border-gray-200 bg-gray-50 py-4 pl-12 pr-5 text-lg placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 min-[390px]:py-5 min-[390px]:pl-14 min-[390px]:text-xl"})]})]}),_.jsxs("div",{children:[_.jsx("label",{className:"mb-2 block text-lg font-bold text-gray-900 min-[390px]:mb-3 min-[390px]:text-xl",children:t("password")}),_.jsxs("div",{className:"relative",children:[_.jsx(qu,{className:"absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-gray-400 min-[390px]:h-6 min-[390px]:w-6"}),_.jsx("input",{type:h?"text":"password",value:l,onChange:N=>u(N.target.value),placeholder:t("enterPassword"),required:!0,className:"w-full rounded-2xl border border-gray-200 bg-gray-50 py-4 pl-12 pr-12 text-lg placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 min-[390px]:py-5 min-[390px]:pl-14 min-[390px]:pr-14 min-[390px]:text-xl"}),_.jsx("button",{type:"button",onClick:()=>p(!h),className:"absolute right-4 top-1/2 -translate-y-1/2 text-gray-400",children:_.jsx(Mx,{className:"h-5 w-5 min-[390px]:h-6 min-[390px]:w-6"})})]})]}),m&&_.jsx("p",{className:"text-base font-bold text-red-600 min-[390px]:text-lg",children:m}),_.jsxs("button",{type:"submit",disabled:y,className:"flex w-full items-center justify-center gap-3 rounded-2xl bg-green-700 py-4 text-xl font-bold text-white transition-transform active:scale-95 disabled:bg-gray-400 disabled:active:scale-100 min-[390px]:py-5 min-[390px]:text-2xl",children:[_.jsx(qu,{className:"h-5 w-5 min-[390px]:h-6 min-[390px]:w-6"}),y?"Logging in...":t("logIn")]}),_.jsx("button",{type:"button",className:"w-full text-lg font-bold text-gray-700 underline min-[390px]:text-xl",children:t("forgotPassword")})]}),_.jsxs("div",{className:"my-5 flex items-center gap-4 min-[390px]:my-8",children:[_.jsx("div",{className:"flex-1 h-px bg-gray-200"}),_.jsx("span",{className:"text-gray-500 font-bold text-lg",children:t("or")}),_.jsx("div",{className:"flex-1 h-px bg-gray-200"})]}),_.jsxs("button",{type:"button",onClick:e,className:"flex w-full items-center gap-4 rounded-2xl border border-green-200 bg-green-50 p-4 transition-colors active:bg-green-100 min-[390px]:p-5",children:[_.jsxs("div",{className:"flex-1 text-left",children:[_.jsx("h3",{className:"text-lg font-bold text-gray-900 min-[390px]:text-xl",children:t("caregiverLogin")}),_.jsx("p",{className:"text-sm text-gray-600 min-[390px]:text-base",children:t("caregiverDesc")})]}),_.jsx(wy,{className:"w-6 h-6 text-gray-400 flex-shrink-0"})]})]})})})}function bP({onContinue:r}){const{t:e,i18n:t}=Ri(),[s,o]=te.useState("en"),l=[{id:"en",name:e("english")},{id:"ms",name:e("malay")},{id:"zh",name:e("chinese")},{id:"ta",name:e("tamil")}],u=h=>{o(h),t.changeLanguage(h)};return _.jsxs("div",{className:"flex h-full flex-col overflow-y-auto bg-gray-50 p-5 min-[390px]:p-8",children:[_.jsxs("div",{className:"flex-1",children:[_.jsx("h1",{className:"mb-8 text-4xl font-bold leading-tight text-green-700 min-[390px]:mb-12 min-[390px]:text-5xl",children:e("selectLanguage")}),_.jsx("div",{className:"space-y-3 min-[390px]:space-y-4",children:l.map((h,p)=>_.jsxs("button",{onClick:()=>u(h.id),className:`flex w-full items-center gap-4 rounded-2xl bg-white p-4 transition-all min-[390px]:gap-5 min-[390px]:p-6 ${s===h.id?"ring-2 ring-green-600":"ring-1 ring-gray-200"}`,children:[_.jsxs("span",{className:"w-7 text-xl font-bold text-gray-600 min-[390px]:w-8 min-[390px]:text-2xl",children:[p+1,"."]}),_.jsx("span",{className:"flex-1 text-left text-xl font-bold text-gray-900 min-[390px]:text-2xl",children:h.name}),s===h.id&&_.jsx("div",{className:"flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-green-600 min-[390px]:h-10 min-[390px]:w-10",children:_.jsx(Sx,{className:"h-5 w-5 text-white min-[390px]:h-6 min-[390px]:w-6",strokeWidth:3})})]},h.id))})]}),_.jsxs("button",{onClick:r,className:"mt-6 flex w-full items-center justify-center gap-3 rounded-full bg-green-700 py-4 text-xl font-bold text-white transition-transform active:scale-95 min-[390px]:py-6 min-[390px]:text-2xl",children:[e("continue"),_.jsx(mx,{className:"h-6 w-6 min-[390px]:h-7 min-[390px]:w-7"})]})]})}const AP="/assets/image-2-Cz1ZQkun.png",Hu={pad21740:"M12.188 2.031C6.579 2.031 2.031 6.579 2.031 12.188c0 5.608 4.548 10.156 10.157 10.156 5.608 0 10.156-4.548 10.156-10.156C22.344 6.579 17.796 2.031 12.188 2.031Zm0 2.032a8.105 8.105 0 0 1 8.125 8.125 8.105 8.105 0 0 1-8.125 8.125 8.105 8.105 0 0 1-8.126-8.125 8.105 8.105 0 0 1 8.126-8.126Zm3.53 4.198-4.546 4.545-2.03-2.03-1.438 1.437 3.468 3.468 5.983-5.983-1.437-1.437Z",p22515f80:"M24.375 4.063c-11.22 0-20.313 9.093-20.313 20.312s9.094 20.313 20.313 20.313 20.313-9.094 20.313-20.313S35.594 4.062 24.375 4.062Zm9.698 16.445L22.202 32.379l-6.617-6.617 2.872-2.872 3.745 3.745 8.999-8.999 2.872 2.872Z",p1eb81b40:"M7.5 0C5.843 0 4.5 1.343 4.5 3v6c0 1.657 1.343 3 3 3s3-1.343 3-3V3c0-1.657-1.343-3-3-3Zm-6 8.25a.75.75 0 0 1 1.5 0V9c0 2.486 2.014 4.5 4.5 4.5S12 11.486 12 9v-.75a.75.75 0 0 1 1.5 0V9a6.001 6.001 0 0 1-5.25 5.953V18h3a.75.75 0 0 1 0 1.5h-7.5a.75.75 0 0 1 0-1.5h3v-3.047A6.001 6.001 0 0 1 1.5 9v-.75Z"};function gy({onSOSClick:r,onCheckIn:e}){const{t}=Ri();return _.jsxs("div",{className:"bg-white content-stretch flex flex-col items-start relative size-full overflow-y-auto",children:[_.jsx("div",{className:"bg-[#fbf9f8] relative shrink-0 w-full",children:_.jsx("div",{className:"flex flex-row items-center size-full",children:_.jsxs("div",{className:"content-stretch flex items-center justify-between px-5 py-2 relative size-full min-[390px]:px-6",children:[_.jsx("div",{className:"content-stretch flex items-center justify-center relative shrink-0 size-9 min-[390px]:size-10",children:_.jsx("div",{className:"relative shrink-0 size-[24.375px]",children:_.jsx("svg",{className:"absolute block inset-0 size-full",fill:"none",preserveAspectRatio:"none",viewBox:"0 0 24.375 24.375",children:_.jsx("g",{id:"Container",children:_.jsx("path",{d:Hu.pad21740,fill:"var(--fill-0, #316342)",id:"Symbol"})})})})}),_.jsx("div",{className:"content-stretch flex flex-[1_0_0] flex-col items-center min-w-px relative",children:_.jsx("div",{className:"flex flex-col font-['Lexend:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#316342] text-[40px] text-center whitespace-nowrap min-[390px]:text-[50px]",children:_.jsx("p",{className:"leading-[44px] min-[390px]:leading-[50px]",children:t("home")})})}),_.jsxs("div",{className:"bg-[#dcd9d9] relative rounded-[9999px] shrink-0 size-11 min-[390px]:size-12",children:[_.jsx("div",{className:"content-stretch flex flex-col items-start justify-center overflow-clip p-[2px] relative rounded-[inherit] size-full",children:_.jsx("div",{className:"flex-[1_0_0] min-h-px relative w-full",children:_.jsx("div",{className:"absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden pointer-events-none",children:_.jsx("img",{alt:"",className:"absolute left-0 max-w-none size-full top-0 object-cover",src:AP})})})}),_.jsx("div",{"aria-hidden":"true",className:"absolute border-2 border-[#f0eded] border-solid inset-0 pointer-events-none rounded-[9999px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]"})]})]})})}),_.jsx("div",{className:"relative flex-1 w-full",children:_.jsx("div",{className:"flex flex-col items-center size-full",children:_.jsxs("div",{className:"content-stretch flex flex-col items-center px-5 pb-4 relative size-full min-[390px]:px-6",children:[_.jsx("div",{className:"content-stretch flex flex-col items-start pb-3 pt-2 relative shrink-0 w-full min-[390px]:pb-[18px] min-[390px]:pt-3",children:_.jsxs("div",{className:"content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full",children:[_.jsx("div",{className:"content-stretch flex flex-col items-center relative shrink-0 w-full",children:_.jsx("div",{className:"flex flex-col font-['Lexend:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#1b1c1c] text-[28px] text-center whitespace-nowrap min-[390px]:text-[32px]",children:_.jsx("p",{className:"leading-9 min-[390px]:leading-[42px]",children:t("dailyCheckIn")})})}),_.jsx("div",{className:"content-stretch flex flex-col items-center relative shrink-0 w-full",children:_.jsx("div",{className:"flex flex-col font-['Lexend:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#414942] text-lg text-center whitespace-nowrap min-[390px]:text-[20px]",children:_.jsx("p",{className:"leading-6 min-[390px]:leading-[30px]",children:t("howAreYouToday")})})})]})}),_.jsx("div",{className:"content-stretch flex flex-col items-start pb-4 relative shrink-0 w-full min-[390px]:pb-6",children:_.jsxs("button",{onClick:e,className:"bg-[#4a7c59] content-stretch flex flex-col items-center justify-center py-5 relative rounded-[28px] shrink-0 w-full active:scale-95 transition-transform min-[390px]:rounded-[32px] min-[390px]:py-8",children:[_.jsx("div",{className:"absolute bg-[rgba(255,255,255,0)] inset-[0_0_-0.25px_0] rounded-[32px] shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)]"}),_.jsx("div",{className:"content-stretch flex flex-col items-start pb-2 relative shrink-0 min-[390px]:pb-3",children:_.jsx("div",{className:"relative shrink-0 size-10 min-[390px]:size-[48.75px]",children:_.jsx("svg",{className:"absolute block inset-0 size-full",fill:"none",preserveAspectRatio:"none",viewBox:"0 0 48.75 48.75",children:_.jsx("g",{id:"Container",opacity:"0.9",children:_.jsx("path",{d:Hu.p22515f80,fill:"var(--fill-0, #E1FFE5)",id:"Symbol"})})})})}),_.jsx("div",{className:"content-stretch flex flex-col items-center relative shrink-0",children:_.jsx("div",{className:"flex flex-col font-['Lexend:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#e1ffe5] text-[32px] text-center tracking-[1px] whitespace-nowrap min-[390px]:text-[40px]",children:_.jsx("p",{className:"leading-10 min-[390px]:leading-[60px]",children:t("iAmOk")})})})]})}),_.jsx("div",{className:"content-stretch flex flex-col items-start relative shrink-0 w-full",children:_.jsxs("div",{className:"content-stretch flex items-center justify-center relative shrink-0 w-full",children:[_.jsxs("button",{onClick:r,className:"bg-[#ba1a1a] content-stretch flex flex-col items-center justify-center relative rounded-[9999px] shrink-0 size-[clamp(212px,58vw,240px)] active:scale-95 transition-transform min-[390px]:size-[clamp(248px,68vw,292px)]",children:[_.jsx("div",{className:"-translate-x-1/2 -translate-y-1/2 absolute bg-[rgba(255,255,255,0)] left-1/2 rounded-[9999px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] size-full top-1/2"}),_.jsx("div",{className:"content-stretch flex flex-col h-[120px] items-start pb-[8px] relative shrink-0 w-[112px] scale-75 min-[390px]:scale-100",children:_.jsxs("div",{className:"relative shrink-0 size-[112px]",children:[_.jsx("div",{className:"absolute bg-white bottom-0 h-[16px] left-0 right-0 rounded-[6px]"}),_.jsx("div",{className:"-translate-x-1/2 absolute bg-white bottom-[16px] h-[40px] left-1/2 rounded-tl-[9999px] rounded-tr-[9999px] w-[48px]"}),_.jsx("div",{className:"-translate-x-1/2 absolute bg-white h-[16px] left-1/2 rounded-[9999px] top-[8px] w-[8px]"}),_.jsx("div",{className:"absolute flex items-center justify-center left-[7.51px] size-[16.971px] top-[11.51px]",children:_.jsx("div",{className:"flex-none rotate-45",children:_.jsx("div",{className:"bg-white h-[8px] relative rounded-[9999px] w-[16px]"})})}),_.jsx("div",{className:"absolute flex items-center justify-center right-[7.52px] size-[16.971px] top-[11.52px]",children:_.jsx("div",{className:"-rotate-45 flex-none",children:_.jsx("div",{className:"bg-white h-[8px] relative rounded-[9999px] w-[16px]"})})})]})}),_.jsx("div",{className:"content-stretch flex flex-col items-start pt-[4px] relative shrink-0 min-[390px]:pt-[8px]",children:_.jsx("div",{className:"content-stretch drop-shadow-[0px_2px_1px_rgba(0,0,0,0.06),0px_4px_1.5px_rgba(0,0,0,0.07)] flex flex-col items-center relative shrink-0",children:_.jsx("div",{className:"flex flex-col font-['Lexend:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[42px] text-center text-white tracking-[4px] whitespace-nowrap min-[390px]:text-[52px] min-[390px]:tracking-[5.2px]",children:_.jsx("p",{className:"leading-[54px] min-[390px]:leading-[78px]",children:t("sosButton")})})})})]}),_.jsxs("button",{className:"absolute bg-white bottom-0 content-stretch flex items-center justify-center p-px right-[-4px] rounded-[9999px] size-12 active:scale-95 transition-transform min-[390px]:right-[-8px] min-[390px]:size-14",children:[_.jsx("div",{"aria-hidden":"true",className:"absolute border border-[#f0eded] border-solid inset-0 pointer-events-none rounded-[9999px]"}),_.jsx("div",{className:"absolute bg-[rgba(255,255,255,0)] bottom-0 right-0 rounded-[9999px] shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)] size-[56px]"}),_.jsx("div",{className:"h-[21.75px] relative shrink-0 w-[15px]",children:_.jsx("svg",{className:"absolute block inset-0 size-full",fill:"none",preserveAspectRatio:"none",viewBox:"0 0 15 21.75",children:_.jsx("g",{id:"Container",children:_.jsx("path",{d:Hu.p1eb81b40,fill:"var(--fill-0, #944A00)",id:"Symbol"})})})})]})]})})]})})})]})}const Ku={p256e1340:"M10 1.667a8.333 8.333 0 1 0 0 16.666 8.333 8.333 0 0 0 0-16.666Zm.833 4.166a.833.833 0 0 0-1.666 0V10c0 .221.088.433.244.589l2.5 2.5a.833.833 0 1 0 1.178-1.178l-2.256-2.255V5.833Z",p8d35f80:"M1.333 0 19 8 1.333 16V9.778L12.333 8 1.333 6.222V0Z",p28843fc0:"M10 8.586 14.95 3.636a1 1 0 1 1 1.414 1.414L11.414 10l4.95 4.95a1 1 0 0 1-1.414 1.414L10 11.414l-4.95 4.95a1 1 0 0 1-1.414-1.414L8.586 10l-4.95-4.95A1 1 0 0 1 5.05 3.636L10 8.586Z"};function OP({onConfirm:r,onCancel:e}){const{t}=Ri(),[s,o]=te.useState(15);return te.useEffect(()=>{if(s>0){const l=setTimeout(()=>o(s-1),1e3);return()=>clearTimeout(l)}e()},[s,e]),_.jsx("div",{className:"content-stretch flex flex-col items-start bg-[#fff4f2] pb-8 pt-5 relative size-full overflow-y-auto min-[390px]:pb-20 min-[390px]:pt-14",children:_.jsx("div",{className:"relative min-h-full w-full",children:_.jsx("div",{className:"flex min-h-full flex-col items-center justify-center overflow-clip rounded-[inherit] w-full",children:_.jsxs("div",{className:"content-stretch flex flex-col items-center justify-center bg-[#fff4f2] px-5 py-5 relative size-full min-[390px]:px-6 min-[390px]:py-8",children:[_.jsx("div",{className:"content-stretch flex flex-col items-start pb-5 relative shrink-0 min-[390px]:pb-8",children:_.jsxs("div",{className:"content-stretch flex items-center justify-center relative shrink-0",children:[_.jsx("div",{className:"absolute left-[-14px] top-[-14px] size-[168px] rounded-[9999px] bg-[#ba1a1a] animate-ping min-[390px]:left-[-16px] min-[390px]:top-[-16px] min-[390px]:size-[192px]"}),_.jsx("div",{className:"absolute left-[-14px] top-[-14px] size-[168px] rounded-[9999px] bg-[#ba1a1a] min-[390px]:left-[-16px] min-[390px]:top-[-16px] min-[390px]:size-[192px]"}),_.jsxs("div",{className:"bg-[#ba1a1a] content-stretch flex items-center justify-center p-1 relative rounded-[9999px] shrink-0 size-[140px] min-[390px]:size-[160px]",children:[_.jsx("div",{"aria-hidden":"true",className:"absolute border-4 border-[#fbf9f8] border-solid inset-0 pointer-events-none rounded-[9999px]"}),_.jsx("div",{className:"-translate-x-1/2 -translate-y-1/2 absolute bg-[rgba(255,255,255,0)] left-1/2 rounded-[9999px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] size-full top-1/2"}),_.jsx("div",{className:"bg-white min-w-[88px] px-5 py-2 relative rounded-[12px] shrink-0",children:_.jsx("span",{className:"block font-['Lexend:SemiBold',sans-serif] font-semibold text-[#ba1a1a] text-[34px] leading-[40px] tracking-[6px] text-center",children:"SOS"})})]})]})}),_.jsx("div",{className:"content-stretch flex flex-col items-start pb-4 relative shrink-0 min-[390px]:pb-6",children:_.jsx("div",{className:"content-stretch flex flex-col gap-[8px] items-center relative shrink-0",children:_.jsx("div",{className:"content-stretch flex flex-col items-center relative shrink-0 w-full",children:_.jsxs("div",{className:"flex flex-col font-['Lexend:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#1b1c1c] text-[28px] text-center min-[390px]:text-[32px]",children:[_.jsx("p",{className:"mb-0 leading-9 min-[390px]:leading-[42px]",children:t("didYouMeanToSendSOS1")}),_.jsx("p",{className:"leading-9 min-[390px]:leading-[42px]",children:t("didYouMeanToSendSOS2")})]})})})}),_.jsx("div",{className:"content-stretch flex flex-col items-start max-w-[384px] pb-5 relative shrink-0 w-full min-[390px]:pb-8",children:_.jsx("div",{className:"bg-[#f0eded] max-w-[384px] relative rounded-[32px] shrink-0 w-full",children:_.jsx("div",{className:"flex flex-row items-center justify-center max-w-[inherit] size-full",children:_.jsxs("div",{className:"content-stretch flex gap-[8px] items-center justify-center max-w-[inherit] p-[8px] relative size-full",children:[_.jsx("div",{className:"relative shrink-0 size-[20px]",children:_.jsx("svg",{className:"absolute block inset-0 size-full",fill:"none",preserveAspectRatio:"none",viewBox:"0 0 20 20",children:_.jsx("g",{id:"Container",children:_.jsx("path",{d:Ku.p256e1340,fill:"#414942",id:"Icon"})})})}),_.jsx("div",{className:"content-stretch flex flex-col items-start relative shrink-0",children:_.jsx("div",{className:"flex flex-col font-['Lexend:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#1b1c1c] text-[20px] tracking-[0.4px] whitespace-nowrap",children:_.jsxs("p",{className:"leading-[24px]",children:[t("autoCancelIn")," ",s," ",t("seconds")]})})})]})})})}),_.jsx("div",{className:"content-stretch flex flex-col items-start justify-center max-w-[384px] min-h-[128px] relative shrink-0 w-full min-[390px]:h-[203px] min-[390px]:pt-[75px]",children:_.jsxs("div",{className:"content-stretch flex flex-col gap-[16px] items-start max-w-[384px] relative shrink-0 w-full",children:[_.jsxs("button",{onClick:r,className:"bg-[#ba1a1a] content-stretch drop-shadow-[0px_8px_10px_rgba(186,26,26,0.15)] flex gap-[7.99px] items-center justify-center min-h-[56px] pb-[16px] pt-[15.5px] relative rounded-[9999px] shrink-0 w-full active:scale-95 transition-transform",children:[_.jsx("div",{className:"h-[16px] relative shrink-0 w-[19px]",children:_.jsx("svg",{className:"absolute block inset-0 size-full",fill:"none",preserveAspectRatio:"none",viewBox:"0 0 19 16",children:_.jsx("g",{id:"Container",children:_.jsx("path",{d:Ku.p8d35f80,fill:"white",id:"Icon"})})})}),_.jsx("div",{className:"flex flex-col font-['Lexend:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[20px] text-center text-white tracking-[0.4px] whitespace-nowrap",children:_.jsx("p",{className:"leading-[24px]",children:t("SOS")})})]}),_.jsxs("button",{onClick:e,className:"bg-[#fbf9f8] content-stretch flex gap-[8px] items-center justify-center min-h-[56px] pb-[16px] pt-[15.5px] px-[2px] relative rounded-[9999px] shrink-0 w-full active:scale-95 transition-transform",children:[_.jsx("div",{"aria-hidden":"true",className:"absolute border-2 border-[#c1c9bf] border-solid inset-0 pointer-events-none rounded-[9999px]"}),_.jsx("div",{className:"relative shrink-0 size-[20px]",children:_.jsx("svg",{className:"absolute block inset-0 size-full",fill:"none",preserveAspectRatio:"none",viewBox:"0 0 20 20",children:_.jsx("g",{id:"Container",children:_.jsx("path",{d:Ku.p28843fc0,fill:"#1B1C1C",id:"Icon"})})})}),_.jsx("div",{className:"flex flex-col font-['Lexend:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#1b1c1c] text-[20px] text-center tracking-[0.4px] whitespace-nowrap",children:_.jsx("p",{className:"leading-[24px]",children:t("cancelSOS")})})]})]})})]})})})})}function LP({onLogout:r}){const{t:e}=Ri(),[t,s]=te.useState(()=>Dr.currentUser),o=(t==null?void 0:t.email)??"No email found",l=te.useMemo(()=>{var u,h;return(u=t==null?void 0:t.displayName)!=null&&u.trim()?t.displayName.trim():((h=t==null?void 0:t.email)==null?void 0:h.split("@")[0])||"My Profile"},[t]);return te.useEffect(()=>g_(Dr,s),[]),_.jsxs("div",{className:"h-full overflow-y-auto bg-gray-50",children:[_.jsxs("div",{className:"bg-gradient-to-br from-green-400 to-green-600 px-5 pb-5 pt-6 text-white min-[390px]:px-7 min-[390px]:pb-7 min-[390px]:pt-8",children:[_.jsxs("div",{className:"mb-4 flex items-center gap-4 min-[390px]:gap-5",children:[_.jsx("div",{className:"flex h-16 w-16 items-center justify-center rounded-full bg-white text-[#316342] min-[390px]:h-20 min-[390px]:w-20",children:_.jsx(zs,{className:"h-8 w-8 min-[390px]:h-10 min-[390px]:w-10"})}),_.jsxs("div",{className:"min-w-0",children:[_.jsx("h2",{className:"truncate text-2xl font-bold min-[390px]:text-3xl",children:l}),_.jsx("p",{className:"mt-1 truncate text-sm text-green-100 min-[390px]:text-base",children:o})]})]}),_.jsx("button",{className:"rounded-full bg-white/20 px-5 py-2.5 text-base font-bold backdrop-blur transition-colors active:bg-white/30 min-[390px]:px-6 min-[390px]:py-3 min-[390px]:text-lg",children:e("editProfile")})]}),_.jsxs("div",{className:"space-y-5 p-5 min-[390px]:space-y-6 min-[390px]:p-8",children:[_.jsxs("div",{className:"overflow-hidden rounded-2xl bg-white shadow-sm",children:[_.jsx(Ns,{icon:_.jsx(zs,{className:"h-7 w-7 min-[390px]:h-8 min-[390px]:w-8"}),title:e("personalInfo")}),_.jsx(Ns,{icon:_.jsx(Us,{className:"h-7 w-7 min-[390px]:h-8 min-[390px]:w-8"}),title:e("notifications")}),_.jsx(Ns,{icon:_.jsx(Xx,{className:"h-7 w-7 min-[390px]:h-8 min-[390px]:w-8"}),title:e("privacySecurity")})]}),_.jsxs("div",{className:"overflow-hidden rounded-2xl bg-white shadow-sm",children:[_.jsx(Ns,{icon:_.jsx(Px,{className:"h-7 w-7 min-[390px]:h-8 min-[390px]:w-8"}),title:e("helpSupport")}),_.jsx(Ns,{icon:_.jsx(Bx,{className:"h-7 w-7 min-[390px]:h-8 min-[390px]:w-8"}),title:e("logOut"),textColor:"text-red-500",onClick:r})]})]})]})}function Ns({icon:r,title:e,textColor:t="text-gray-900",onClick:s}){return _.jsxs("button",{onClick:s,className:"flex w-full items-center gap-4 border-b border-gray-100 px-5 py-4 transition-colors last:border-b-0 active:bg-gray-50 min-[390px]:gap-6 min-[390px]:px-8 min-[390px]:py-6",children:[_.jsx("div",{className:"text-gray-600",children:r}),_.jsx("span",{className:`flex-1 text-left text-xl font-bold min-[390px]:text-2xl ${t}`,children:e}),_.jsx(wy,{className:"h-7 w-7 text-gray-400 min-[390px]:h-8 min-[390px]:w-8"})]})}const DP=r=>`careconnect.points.${r}`;function MP(){const[r,e]=te.useState(()=>Dr.currentUser),[t,s]=te.useState(0),o=te.useMemo(()=>{var l,u;return((l=r==null?void 0:r.displayName)==null?void 0:l.trim())||((u=r==null?void 0:r.email)==null?void 0:u.split("@")[0])||"User"},[r]);return te.useEffect(()=>g_(Dr,e),[]),te.useEffect(()=>{if(!r){s(0);return}const l=DP(r.uid);s(Number(localStorage.getItem(l))||0);const u=p=>{const{uid:m,points:v}=p.detail||{};m===r.uid&&s(Number(v)||0)};window.addEventListener("careconnect-points-updated",u);const h=n0(Sd(kd,`users/${r.uid}/points`),p=>{const m=Number(p.val());Number.isFinite(m)&&(s(m),localStorage.setItem(l,String(m)))},p=>{console.error("Unable to load points:",p),s(Number(localStorage.getItem(l))||0)});return()=>{window.removeEventListener("careconnect-points-updated",u),h()}},[r]),_.jsxs("div",{className:"h-full overflow-y-auto bg-[#fbf9f8] text-[#1b1c1c]",children:[_.jsx("header",{className:"sticky top-0 z-10 bg-[#fbf9f8] shadow-sm",children:_.jsxs("div",{className:"flex h-14 items-center justify-between px-5 min-[390px]:h-16 min-[390px]:px-6",children:[_.jsxs("div",{className:"flex items-center gap-2 text-[#316342]",children:[_.jsx(zs,{className:"h-6 w-6 fill-current min-[390px]:h-7 min-[390px]:w-7"}),_.jsx("span",{className:"text-xl font-bold min-[390px]:text-2xl",children:"CareConnect"})]}),_.jsx("button",{"aria-label":"Notifications",className:"flex h-10 w-10 items-center justify-center rounded-full text-[#414942] transition-colors active:scale-95 active:bg-[#e4e2e1] min-[390px]:h-12 min-[390px]:w-12",children:_.jsx(Us,{className:"h-6 w-6 min-[390px]:h-7 min-[390px]:w-7"})})]})}),_.jsxs("main",{className:"flex flex-col gap-5 px-5 py-5 min-[390px]:gap-8 min-[390px]:px-6 min-[390px]:py-8",children:[_.jsxs("section",{className:"flex flex-col items-center rounded-[28px] bg-[#f6f3f2] p-5 text-center shadow-[0_8px_20px_rgba(49,99,66,0.08)] min-[390px]:rounded-[32px] min-[390px]:p-6",children:[_.jsx("div",{className:"mb-3 flex h-24 w-24 items-center justify-center rounded-full bg-[#ff9742] text-[#6c3400] min-[390px]:mb-4 min-[390px]:h-32 min-[390px]:w-32",children:_.jsx(zs,{className:"h-12 w-12 fill-current min-[390px]:h-16 min-[390px]:w-16"})}),_.jsxs("div",{className:"mb-2 flex items-center justify-center gap-2",children:[_.jsx(nS,{className:"h-8 w-8 fill-[#ff9742] text-[#ff9742] min-[390px]:h-10 min-[390px]:w-10"}),_.jsxs("h1",{className:"text-[32px] font-bold leading-10 text-[#316342] min-[390px]:text-[40px] min-[390px]:leading-[52px]",children:[t," Points"]})]}),_.jsxs("p",{className:"text-base leading-6 text-[#414942] min-[390px]:text-lg min-[390px]:leading-7",children:["Great job, ",o,"! Keep staying active to earn more."]})]}),_.jsxs("section",{className:"flex items-center justify-between rounded-[28px] bg-[#4a7c59] p-4 shadow-[0_8px_20px_rgba(49,99,66,0.08)] min-[390px]:rounded-[32px] min-[390px]:p-6",children:[_.jsxs("div",{className:"flex items-center gap-3 text-[#e1ffe5] min-[390px]:gap-4",children:[_.jsx(_x,{className:"h-8 w-8 fill-current min-[390px]:h-9 min-[390px]:w-9"}),_.jsxs("div",{children:[_.jsx("h2",{className:"text-lg font-semibold leading-6 min-[390px]:text-xl",children:"Daily Check-in"}),_.jsx("p",{className:"text-base leading-6 opacity-90 min-[390px]:text-lg min-[390px]:leading-7",children:"Log in today"})]})]}),_.jsx("div",{className:"rounded-full bg-[#e1ffe5] px-3 py-2 text-lg font-semibold text-[#4a7c59] shadow-sm min-[390px]:px-4 min-[390px]:text-xl",children:"+5"})]}),_.jsxs("section",{children:[_.jsx("h2",{className:"mb-3 text-xl font-semibold leading-7 text-[#1b1c1c] min-[390px]:mb-4 min-[390px]:text-2xl min-[390px]:leading-8",children:"Redeem Rewards"}),_.jsxs("div",{className:"flex flex-col gap-4",children:[_.jsx(yy,{icon:_.jsx(eS,{className:"h-8 w-8"}),title:"$5 NTUC Voucher",cost:50,userPoints:t}),_.jsx(yy,{icon:_.jsx(wx,{className:"h-8 w-8"}),title:"$10 Grab Voucher",cost:100,userPoints:t})]})]})]})]})}function yy({icon:r,title:e,cost:t,userPoints:s}){const o=s>=t;return _.jsxs("div",{className:`flex items-center rounded-[32px] p-4 shadow-[0_8px_20px_rgba(49,99,66,0.08)] transition-colors ${o?"bg-[#f0eded]":"bg-gray-100 opacity-70"}`,children:[_.jsx("div",{className:`mr-3 flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-2xl min-[390px]:mr-4 min-[390px]:h-16 min-[390px]:w-16 ${o?"bg-[#fbf9f8] text-[#316342]":"bg-gray-200 text-gray-400"}`,children:r}),_.jsxs("div",{className:"min-w-0 flex-1",children:[_.jsx("h3",{className:`text-lg font-semibold leading-6 min-[390px]:text-xl ${o?"text-[#1b1c1c]":"text-gray-500"}`,children:e}),_.jsxs("p",{className:`mt-1 text-base font-bold leading-5 ${o?"text-[#316342]":"text-gray-400"}`,children:[t," Points"]})]}),_.jsxs("button",{disabled:!o,className:`flex items-center gap-1.5 rounded-full px-4 py-2.5 text-sm font-semibold leading-5 shadow-sm transition-transform min-[390px]:px-5 min-[390px]:py-3 min-[390px]:text-base ${o?"bg-[#316342] text-white active:scale-95":"cursor-not-allowed bg-gray-300 text-gray-500"}`,children:[o?_.jsx(xy,{className:"h-4 w-4"}):_.jsx(qu,{className:"h-4 w-4"}),"REDEEM"]})]})}function jP(){const[r,e]=te.useState(!1);return _.jsxs("div",{className:"h-full overflow-y-auto bg-[#fafafa] px-5 pb-6 pt-5 text-gray-900 min-[390px]:px-6 min-[390px]:pb-8 min-[390px]:pt-8",children:[_.jsxs("header",{className:"mb-5 flex items-start justify-between min-[390px]:mb-8",children:[_.jsxs("div",{children:[_.jsx("h1",{className:"mb-1 text-2xl font-bold leading-tight tracking-tight min-[390px]:text-[26px]",children:"Medication Reminder"}),_.jsx("p",{className:"text-sm font-medium text-gray-500 min-[390px]:text-[15px]",children:"Never miss a dose."})]}),_.jsxs("button",{"aria-label":"Notifications",className:"relative mt-1 rounded-full p-2 text-[#ff4400] transition-colors active:scale-95 active:bg-[#fff0ea]",children:[_.jsx(Us,{className:"h-6 w-6 min-[390px]:h-7 min-[390px]:w-7"}),_.jsx("span",{className:"absolute right-2 top-2 h-2.5 w-2.5 rounded-full border-2 border-white bg-[#ff4400]"})]})]}),_.jsxs("section",{className:"mb-5 rounded-[24px] border border-gray-100 bg-white p-4 shadow-[0_4px_20px_rgba(0,0,0,0.05)] min-[390px]:mb-8 min-[390px]:p-5",children:[_.jsxs("div",{className:"mb-4 flex items-center justify-between min-[390px]:mb-5",children:[_.jsx("h2",{className:"text-lg font-semibold text-gray-900",children:"Next dose"}),_.jsxs("div",{className:"flex items-center gap-1.5 rounded-full bg-[#e8f5e9] px-3 py-1.5",children:[_.jsx(xy,{className:"h-4 w-4 text-[#2e8b57]"}),_.jsx("span",{className:"text-sm font-medium text-[#2e8b57]",children:r?"Taken":"On time"})]})]}),_.jsxs("div",{className:"flex items-center gap-4 min-[390px]:gap-5",children:[_.jsxs("div",{className:"relative flex h-20 w-20 flex-shrink-0 items-center justify-center overflow-hidden rounded-full bg-orange-50 min-[390px]:h-24 min-[390px]:w-24",children:[_.jsxs("div",{className:"relative flex h-14 w-10 flex-col rounded-b-md rounded-t-lg border border-gray-200 bg-white shadow-sm min-[390px]:h-16 min-[390px]:w-12",children:[_.jsx("div",{className:"h-4 w-full rounded-t-lg bg-gray-200"}),_.jsx("div",{className:"mt-1 flex flex-1 items-center justify-center bg-[#ff4400]",children:_.jsx(Sy,{className:"h-5 w-5 text-white"})})]}),_.jsx("div",{className:"absolute bottom-4 right-4 h-6 w-6 rounded-full border border-gray-200 bg-white shadow"}),_.jsx("div",{className:"absolute bottom-2 right-2 h-6 w-6 rounded-full border border-gray-200 bg-white shadow"})]}),_.jsxs("div",{className:"min-w-0 flex-1",children:[_.jsx("h3",{className:"mb-1 text-lg font-bold leading-tight text-gray-900 min-[390px]:text-[20px]",children:"Atorvastatin 20mg"}),_.jsx("p",{className:"mb-3 text-sm font-medium text-gray-500",children:"1 tablet - Once daily"}),_.jsxs("div",{className:"flex items-center gap-2",children:[_.jsx(Lx,{className:"h-5 w-5 text-[#ff4400]"}),_.jsx("span",{className:"text-base font-bold tracking-tight text-[#ff4400] min-[390px]:text-[18px]",children:"5:45 PM"})]})]})]})]}),_.jsxs("section",{className:"space-y-4",children:[_.jsxs("button",{className:"flex w-full items-center justify-center gap-2 rounded-2xl bg-[#ff4400] py-3.5 text-base font-semibold text-white shadow-sm transition-colors active:scale-95 active:bg-orange-600 min-[390px]:py-4 min-[390px]:text-[17px]",children:[_.jsx(Us,{className:"h-5 w-5"}),_.jsx("span",{children:"Snooze 15 minutes"})]}),_.jsx("button",{onClick:()=>e(!0),className:"w-full rounded-2xl border border-[#ff4400] bg-white py-3.5 text-base font-semibold text-[#ff4400] shadow-sm transition-colors active:scale-95 active:bg-orange-50 min-[390px]:py-4 min-[390px]:text-[17px]",children:"I've taken this dose"})]})]})}function FP({onBack:r}){const[e,t]=te.useState(""),[s,o]=te.useState(""),[l,u]=te.useState("Next-of-Kin"),[h,p]=te.useState(!1),m=e.trim().length>0||s.trim().length>0,v=m&&h,y=w=>{w.preventDefault(),v&&alert("Caregiver registration completed.")};return _.jsxs("div",{className:"h-full overflow-y-auto bg-[#fbf9f8] text-[#1b1c1c]",children:[_.jsxs("header",{className:"sticky top-0 z-10 flex h-14 items-center justify-between bg-[#fbf9f8] px-4 shadow-sm min-[390px]:h-16 min-[390px]:px-6",children:[_.jsx("button",{type:"button",onClick:r,className:"flex h-12 w-12 items-center justify-center text-[#174b2c] transition-transform active:scale-95 min-[390px]:h-14 min-[390px]:w-14","aria-label":"Back",children:_.jsx(fx,{className:"h-6 w-6 min-[390px]:h-7 min-[390px]:w-7"})}),_.jsx("h1",{className:"text-xl font-bold text-[#174b2c] min-[390px]:text-2xl",children:"Care Portal"}),_.jsx("button",{type:"button",className:"flex h-12 w-12 items-center justify-center text-[#414942] transition-transform active:scale-95 min-[390px]:h-14 min-[390px]:w-14","aria-label":"Notifications",children:_.jsx(Us,{className:"h-6 w-6 min-[390px]:h-7 min-[390px]:w-7"})})]}),_.jsxs("form",{onSubmit:y,className:"flex flex-col gap-5 px-5 pb-8 pt-5 min-[390px]:gap-8 min-[390px]:px-6 min-[390px]:pb-12 min-[390px]:pt-8",children:[_.jsxs("section",{className:"flex flex-col gap-3 min-[390px]:gap-4",children:[_.jsx(Gu,{title:"Find Your Senior"}),_.jsx("p",{className:"text-base leading-6 text-[#414942] min-[390px]:text-lg min-[390px]:leading-7",children:"Search for the senior you want to connect with."}),_.jsx(_y,{icon:_.jsx(Qx,{className:"h-6 w-6 min-[390px]:h-7 min-[390px]:w-7"}),label:"Search by Name",placeholder:"Search by name",value:e,onChange:t}),_.jsxs("div",{className:"flex items-center gap-4 py-1",children:[_.jsx("div",{className:"flex-1 h-px bg-[#c1c9bf]"}),_.jsx("span",{className:"text-base font-medium text-[#717971] italic",children:"or"}),_.jsx("div",{className:"flex-1 h-px bg-[#c1c9bf]"})]}),_.jsx(_y,{icon:_.jsx(Gx,{className:"h-6 w-6 min-[390px]:h-7 min-[390px]:w-7"}),label:"Search by Phone Number",placeholder:"Enter senior's phone number",type:"tel",value:s,onChange:o}),!m&&_.jsx("p",{className:"ml-2 text-sm font-medium text-[#b94a1c]",children:"Enter either the senior's name or phone number before completing."})]}),_.jsxs("section",{className:"flex flex-col gap-3 min-[390px]:gap-4",children:[_.jsx(Gu,{title:"Your Relationship"}),_.jsxs("label",{className:"flex flex-col gap-2",children:[_.jsx("span",{className:"text-base font-semibold text-[#1b1c1c] ml-2",children:"Select Relationship"}),_.jsxs("div",{className:"relative flex h-14 items-center rounded-2xl bg-[#f5f3f3] px-4 focus-within:ring-2 focus-within:ring-[#174b2c] min-[390px]:h-16",children:[_.jsx(aS,{className:"mr-3 h-6 w-6 text-[#717971] min-[390px]:h-7 min-[390px]:w-7"}),_.jsxs("select",{value:l,onChange:w=>u(w.target.value),className:"w-full appearance-none border-none bg-transparent text-lg text-[#1b1c1c] outline-none focus:ring-0 min-[390px]:text-xl",children:[_.jsx("option",{children:"Next-of-Kin"}),_.jsx("option",{children:"Family Member"}),_.jsx("option",{children:"Caregiver"}),_.jsx("option",{children:"Helper"})]}),_.jsx(Cx,{className:"pointer-events-none h-6 w-6 text-[#717971] min-[390px]:h-7 min-[390px]:w-7"})]})]})]}),_.jsxs("section",{className:"flex flex-col gap-3 min-[390px]:gap-4",children:[_.jsx(Gu,{title:"Confirmation"}),_.jsxs("label",{className:"flex cursor-pointer gap-3 rounded-2xl border border-[#c1c9bf]/50 bg-white p-4 shadow-sm transition-transform active:scale-[0.99] min-[390px]:gap-4 min-[390px]:p-6",children:[_.jsx("input",{type:"checkbox",className:"sr-only",checked:h,onChange:w=>p(w.target.checked)}),h?_.jsx(Tx,{className:"h-7 w-7 flex-shrink-0 fill-[#174b2c] text-[#174b2c] min-[390px]:h-8 min-[390px]:w-8"}):_.jsx(Ax,{className:"h-7 w-7 flex-shrink-0 text-[#717971] min-[390px]:h-8 min-[390px]:w-8"}),_.jsxs("span",{className:"text-sm font-medium leading-6 text-[#414942] min-[390px]:text-base min-[390px]:leading-7",children:["I confirm that I have the legal authority to register this senior and agree to CareConnect's ",_.jsx("span",{className:"text-[#174b2c] font-bold underline",children:"Privacy Policy"})," ","and ",_.jsx("span",{className:"text-[#174b2c] font-bold underline",children:"Terms of Service"}),"."]})]})]}),_.jsx("button",{type:"submit",disabled:!v,className:"flex h-14 w-full items-center justify-center gap-3 rounded-full bg-[#174b2c] text-lg font-bold text-white shadow-md transition-transform active:scale-95 disabled:cursor-not-allowed disabled:bg-[#aab3aa] disabled:shadow-none disabled:active:scale-100 min-[390px]:h-16 min-[390px]:text-xl",children:"Complete"})]})]})}function Gu({title:r}){return _.jsxs("div",{className:"flex items-center gap-3",children:[_.jsx("div",{className:"h-7 w-1 rounded-full bg-[#fd8a2a] min-[390px]:h-8"}),_.jsx("h2",{className:"text-xl font-bold text-[#174b2c] min-[390px]:text-2xl",children:r})]})}function _y({icon:r,label:e,placeholder:t,type:s="text",value:o,onChange:l}){return _.jsxs("label",{className:"flex flex-col gap-2",children:[_.jsx("span",{className:"text-base font-semibold text-[#1b1c1c] ml-2",children:e}),_.jsxs("div",{className:"relative flex h-14 items-center rounded-2xl bg-[#f5f3f3] px-4 focus-within:ring-2 focus-within:ring-[#174b2c] min-[390px]:h-16",children:[_.jsx("div",{className:"text-[#717971] mr-3",children:r}),_.jsx("input",{type:s,value:o,onChange:u=>l(u.target.value),placeholder:t,className:"w-full border-none bg-transparent text-lg outline-none placeholder:text-[#9ca39c] focus:ring-0 min-[390px]:text-xl"})]})]})}const UP=r=>`careconnect.points.${r}`;function zP(){const{t:r}=Ri(),[e,t]=te.useState("welcome"),[s,o]=te.useState(!1),l=()=>{alert("Emergency contacts have been notified!"),o(!1)},u=async()=>{var y,w;const m=Dr.currentUser;if(!m){alert("Please log in again before checking in."),t("welcome");return}const v=Sd(kd,`users/${m.uid}/points`);try{await NP(v,I=>(Number(I)||0)+5),fP(Sd(kd,`users/${m.uid}/profile`),{email:m.email,name:((y=m.displayName)==null?void 0:y.trim())||((w=m.email)==null?void 0:w.split("@")[0])||"User",lastCheckInAt:IP()}).catch(I=>{console.warn("Profile metadata update failed:",I)}),t("points")}catch(I){console.error("Check-in failed:",I);const N=UP(m.uid),b=(Number(localStorage.getItem(N))||0)+5;localStorage.setItem(N,String(b)),window.dispatchEvent(new CustomEvent("careconnect-points-updated",{detail:{uid:m.uid,points:b}})),t("points")}},h=async()=>{try{await bC(Dr),t("welcome")}catch(m){console.error("Logout failed:",m),alert("Unable to log out. Please try again.")}},p=()=>{switch(e){case"welcome":return _.jsx(PP,{onGetStarted:()=>t("language"),onCaregiverLogin:()=>t("carePortal")});case"language":return _.jsx(bP,{onContinue:()=>t("home")});case"home":return _.jsx(gy,{onSOSClick:()=>o(!0),onCheckIn:u});case"profile":return _.jsx(LP,{onLogout:h});case"points":return _.jsx(MP,{});case"medication":return _.jsx(jP,{});case"carePortal":return _.jsx(FP,{onBack:()=>t("welcome")});default:return _.jsx(gy,{onSOSClick:()=>o(!0),onCheckIn:u})}};return _.jsx("div",{className:"h-[100dvh] w-full overflow-hidden bg-gray-100 min-[415px]:flex min-[415px]:items-center min-[415px]:justify-center",children:_.jsxs("div",{className:"mx-auto flex h-full max-h-[896px] min-h-0 w-full max-w-[414px] flex-col bg-white shadow-2xl min-[415px]:rounded-[2px] relative",children:[_.jsx("div",{className:"flex-1 overflow-hidden",children:p()}),e!=="welcome"&&e!=="language"&&e!=="carePortal"&&_.jsxs("nav",{className:"shrink-0 bg-white border-t-2 border-gray-200 px-2 py-2 flex justify-around items-center",children:[_.jsx(ka,{icon:_.jsx(zx,{className:"h-7 w-7 min-[390px]:h-9 min-[390px]:w-9"}),label:r("home"),active:e==="home",onClick:()=>t("home")}),_.jsx(ka,{icon:_.jsx(Sy,{className:"h-7 w-7 min-[390px]:h-9 min-[390px]:w-9"}),label:r("meds"),active:e==="medication",onClick:()=>t("medication")}),_.jsx(ka,{icon:_.jsx(iS,{className:"h-7 w-7 min-[390px]:h-9 min-[390px]:w-9"}),label:r("points"),active:e==="points",onClick:()=>t("points")}),_.jsx(ka,{icon:_.jsx(zs,{className:"h-7 w-7 min-[390px]:h-9 min-[390px]:w-9"}),label:r("profile"),active:e==="profile",onClick:()=>t("profile")})]}),s&&_.jsx("div",{className:"absolute inset-0 z-50 bg-white",children:_.jsx(OP,{onConfirm:l,onCancel:()=>o(!1)})})]})})}function ka({icon:r,label:e,active:t,onClick:s}){return _.jsxs("button",{onClick:s,className:`flex min-w-[72px] flex-col items-center gap-1 rounded-lg px-1 py-2 transition-colors active:scale-95 min-[390px]:gap-2 min-[390px]:px-2 ${t?"text-green-600":"text-gray-400"}`,children:[r,_.jsx("span",{className:"text-sm font-bold min-[390px]:text-base",children:e})]})}ax.createRoot(document.getElementById("root")).render(_.jsx(zP,{}));
